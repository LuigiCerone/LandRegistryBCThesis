...
contract Logger {
    ...
    event NewDeploy(address contractAddress, uint _landParcel, uint _subaltern, address _landBuyer);
    ...
    function emitTransfer(address _contractAddress, uint _landParcel, uint _subaltern, address _landBuyer) public {
        emit Transfer(_contractAddress, _landParcel, _subaltern, _landBuyer);
    }
}