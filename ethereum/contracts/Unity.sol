...
contract Unity {
    ...
    constructor (address loggerAddress) public{
        owner = msg.sender;
    ...
    function insertLand(bytes2 _district, uint _document, uint _landParcel, uint _subaltern, address _ownerAddress) isOwner public returns (address){
        _land = Land({
            district : _district,
            document : _document,
        ...
        logger.emitNewDeployEvent(_ownerAddress);
    }
